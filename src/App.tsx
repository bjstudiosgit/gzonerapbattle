...
const GlobalDisclaimer = lazy(() => import("./components/GlobalDisclaimer"));
...
function Home() {
  ...
  return (
    <main className={showIntro ? "" : "pt-28 md:pt-32"}>
      ...
      <HostsAndJudges />
      <LostPropertyPreview />
      <section className="relative z-10 border-y border-white/5 bg-zinc-950/70 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <GlobalDisclaimer className="w-full text-sm md:text-lg font-medium tracking-normal" />
        </div>
      </section>
    </main>
  );
