...
function Main() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 selection:bg-brand selection:text-black">
      <div className="bg-brand text-black text-xs font-bold uppercase tracking-widest py-1 overflow-hidden">
        <div className="animate-marquee whitespace-nowrap">
          April tickets now on sale £10 plus booking fee &nbsp;&bull;&nbsp; April tickets now on sale £10 plus booking fee &nbsp;&bull;&nbsp; April tickets now on sale £10 plus booking fee &nbsp;&bull;&nbsp;
        </div>
      </div>
      <ScrollToTop />
      <Navbar />
