...
export default function RoyalRumblePage() {
  const [episodes, setEpisodes] = useState(initialRoyalRumbleEpisodes);
  const [activeEpisode, setActiveEpisode] = useState(initialRoyalRumbleEpisodes[0]);

  useEffect(() => {
    initialRoyalRumbleEpisodes.forEach(async (ep) => {
      try {
  ...
  const structuredData = {
    ...
    name: "Royal Rumble",
    description:
      "The Gzone Royal Rumble series recorded live at Peacocks Gym, Canning Town London.",
    itemListElement: episodes.map((ep, index) => ({
      "@type": "ListItem",
      position: index + 1,
      item: {
        "@type": "VideoObject",
        name: `Royal Rumble - ${ep.title}`,
        description: `Royal Rumble ${ep.title} recorded live at ${ep.location}. Featuring Tricky, Cookie, Passive, Deeno, Mello, 1 Flaymah, Btizz, Badee Harz, Jai-D. Beats by Keegan - K.Sticky.`,
        thumbnailUrl: `https://img.youtube.com/vi/${ep.videoId}/maxresdefault.jpg`,
        uploadDate: "2026-09-04T10:00:39-07:00",
  ...
  return (
    <div className="min-h-screen pt-32 md:pt-44 pb-16 md:pb-24 relative overflow-hidden bg-[#050505]">
      <Helmet>
        <title>Royal Rumble EP1 | The Gzone RBL</title>
        <meta
          name="description"
          content="Watch Royal Rumble EP1 recorded live at Peacocks Gym, Canning Town London. Featuring Tricky, Cookie, Passive, Deeno, Mello, 1 Flaymah, Btizz, Badee Harz, and Jai-D."
        />
        <meta
          name="keywords"
          content="Royal Rumble, Royal Rumble EP1, Gzone, UK Battle Rap, Mello, Tricky, Cookie, Passive, Deeno, 1 Flaymah, Btizz, Badee Harz, Jai-D, Peacocks Gym, Canning Town"
        />
        <link rel="canonical" href="https://www.gzonerapbattle.co.uk/royal-rumble" />

        {/* Open Graph */}
        <meta property="og:type" content="video.other" />
        <meta property="og:title" content="Royal Rumble EP1 | The Gzone RBL" />
        <meta
          property="og:description"
          content="The Gzone have initiated war on the whole scene with this one. Watch Royal Rumble EP1 live at Peacocks Gym."
        />
        <meta property="og:url" content="https://www.gzonerapbattle.co.uk/royal-rumble" />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Royal Rumble EP1 | The Gzone RBL" />
        <meta
          name="twitter:description"
          content="Watch Royal Rumble EP1 recorded live at Peacocks Gym, Canning Town."
        />
        <meta
          name="twitter:image"
          content={`https://img.youtube.com/vi/${activeEpisode.videoId}/maxresdefault.jpg`}
      ...
      <div className="container max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-zinc-400 text-sm md:text-base max-w-3xl leading-relaxed tracking-tight font-medium opacity-90 mx-auto md:mx-0">
            THE GZONE HAVE INITIATED WAR ON THE WHOLE SCENE WITH THIS ONE... THE FIRST OF ITS KIND IN THIS ENVIRONMENT AND OHHHHH IT WENT OFFFF. FEATURING TRICKY, COOKIE, PASSIVE, DEENO, MELLO, 1 FLAYMAH, BTIZZ, BADEE HARZ, JAI-D. BEATS PRODUCED BY KEEGAN - K.STICKY.
          </p>
        </motion.div>
          ...
          <div className="relative group">
            ...
            <div className="relative aspect-video w-full bg-zinc-950 rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
              <iframe
                ...
                title={`Royal Rumble - ${activeEpisode.title}`}
