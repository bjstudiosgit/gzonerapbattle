  ...
  return (
    <div className="min-h-screen pt-40 pb-24 relative overflow-hidden bg-zinc-950">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute top-[10%] left-1/2 -translate-x-1/2 font-display italic text-[20vw] text-white/[0.02] uppercase leading-none select-none tracking-tighter">
          Promoters
        </div>
      </div>
        ...
        <header className="mb-24 px-4 md:px-0 text-center lg:text-left">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <div className="max-w-4xl">
              ...
              <h1 className="text-6xl md:text-[8rem] font-display italic uppercase leading-[0.75] tracking-tighter mb-12 shadow-2xl">
              ...
              <p className="text-zinc-500 text-sm md:text-lg uppercase font-black tracking-[0.2em] leading-relaxed max-w-2xl border-l-0 lg:border-l-2 border-brand/20 lg:pl-6 py-2 mx-auto lg:mx-0">
                The promoters and decision makers running the UK's most <span className="text-white italic">uncensored arena.</span> <br className="hidden md:block" />
            ...
            <div className="lg:text-right bg-white/[0.02] border border-white/5 p-8 rounded-[3rem] backdrop-blur-sm self-center lg:self-start">
              <h2 className="text-3xl md:text-5xl font-display italic uppercase leading-none mb-6 text-brand">THE GZONE ARENA</h2>
              <p className="text-zinc-500 text-[9px] md:text-xs uppercase font-black tracking-[0.3em] leading-relaxed max-w-xs ml-auto">
                No filters. No protection. <br/>
                If it happens in the ring — <span className="text-white italic">they sanctioned it.</span>
              </p>
              <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-end gap-3 text-[9px] font-black uppercase text-zinc-600 tracking-widest">
                <Info size={12} className="text-brand" />
                <span>Sanctioned by G-Zone LTD</span>
              </div>
            </div>
          </div>
        </header>
