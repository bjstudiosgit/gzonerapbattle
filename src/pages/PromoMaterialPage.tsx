...
const eventSections = [
  {
    ...
    flyers: [
      {
        id: "tymeless-deeno",
        title: "Tymeless VS Deeno",
        src: "/flyers/tymelessvsdeeno.png",
        aspect: "aspect-[4/5]"
      },
      {
        id: "roman-marni-grams",
        title: "Roman VS Marni Grams",
        src: "/flyers/romanvsmarnigrams.png",
        aspect: "aspect-[4/5]"
      },
      {
        id: "cj-zino-1flaymah",
        title: "C.J Zino VS 1Flaymah",
        src: "/flyers/cjzinovs1flaymah.png",
        aspect: "aspect-[4/5]"
      },
      {
        id: "natty-ebk-zk",
        title: "Natty EBK VS Z.K",
        src: "/flyers/nattyebkvszk.png",
        aspect: "aspect-[4/5]"
      },
      {
        id: "aj-badee-harz",
        title: "AJ VS Badee Harz",
        src: "/flyers/ajvsbadee.png",
        aspect: "aspect-[4/5]"
      }
    ]
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="space-y-12">
          {eventSections.map((section) => (
            <section key={section.id} className="bg-zinc-900/20 border border-white/5 rounded-[3rem] p-6 md:p-12">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                <div>
                  ...
                  <h2 className="text-3xl md:text-5xl font-display uppercase text-white tracking-tight">{section.title} <span className="text-zinc-500">{section.accent}</span></h2>
                </div>
                <div className="text-zinc-500 text-xs font-black uppercase tracking-widest">
                  {section.flyers.length} Assets Available
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {section.flyers.map((flyer, index) => (
                  <motion.div
                    key={flyer.id}
