  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-zinc-950 text-zinc-300 selection:bg-brand selection:text-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-display italic uppercase text-white mb-8 border-l-8 border-brand pl-6">
          ...
          <div className="prose prose-invert prose-orange max-w-none space-y-8 text-zinc-400 leading-relaxed">
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Introduction</h2>
              <p className="mb-6">
                The G Zone Rap Battle (referred to in this policy as “The G Zone,” “we,” or “us”) is committed to respecting and protecting your privacy. This Privacy Policy describes the personal data we collect through our website at gzonerapbattle.co.uk and any related services (together, the “Site”), how we use and share that data, and the rights you have.
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Who We Are</h2>
              <p className="mb-4">
                The Site is operated by BJStudios, on behalf of The G Zone Rap Battle League and Ginja Entertainment, in association with Peacock Gymnasium.
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">What Personal Data We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">How We Use Your Data and Our Lawful Bases</h2>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Cookies and Analytics</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Sharing Your Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Retention of Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Security Measures</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Your Rights</h2>
            ...
            <section>
              <h2 className="text-2xl font-display italic uppercase text-white mb-4">Contact Us</h2>
              <p>
