      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="prose prose-invert prose-orange max-w-none space-y-8 text-zinc-400 leading-relaxed">
            ...
            <section>
              <p>
                The Site is operated by BJStudios, on behalf of The Gzone Rap Battle League and Ginga Entertainment, in association with Peacock Gymnasium.
              </p>
            </section>
                ...
                <table className="w-full text-left border-collapse border border-white/10 rounded-xl overflow-hidden">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="p-4 border border-white/10 text-sm">Name, email address, phone number, city, social media handles, audition video link and short message provided through our MC application form; email addresses submitted when you join our mailing list.</td>
                      <td className="p-4 border border-white/10 text-sm">To review MC applications, contact applicants, send newsletters or event updates, and otherwise communicate with you.</td>
                    </tr>
                    ...
                    <tr className="bg-white/5">
                      ...
                      <td className="p-4 border border-white/10 text-sm">Videos or links that you submit when applying to be an MC, plus comments or other content you send to us.</td>
                      <td className="p-4 border border-white/10 text-sm">To evaluate applications, host content in our league, and manage community submissions.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              ...
              <p className="mt-4">
                We never sell your personal data; the table below explains who we may share it with and why.{" "}
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse border border-white/10 rounded-xl overflow-hidden">
                  <thead>
                    <tr className="bg-zinc-900">
                      <th className="p-4 border border-white/10 text-brand uppercase text-xs tracking-widest">Category</th>
                      <th className="p-4 border border-white/10 text-brand uppercase text-xs tracking-widest">Who we share with</th>
                      <th className="p-4 border border-white/10 text-brand uppercase text-xs tracking-widest">Why we share it</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="p-4 border border-white/10 font-bold text-white">Service providers</td>
                      <td className="p-4 border border-white/10 text-sm">123 Reg, Vercel, Supabase, Google Analytics, and YouTube (Google).</td>
                      <td className="p-4 border border-white/10 text-sm">To manage our domain and DNS, host the website, run database and authentication services, understand site traffic, and display embedded video content.</td>
                    </tr>
                    <tr>
                      <td className="p-4 border border-white/10 font-bold text-white">Transaction platforms</td>
                      <td className="p-4 border border-white/10 text-sm">Eventbrite and merchandise payment providers.</td>
                      <td className="p-4 border border-white/10 text-sm">To process event tickets, merchandise orders, payments, fulfilment, and related purchase support.</td>
                    </tr>
                    <tr>
                      <td className="p-4 border border-white/10 font-bold text-white">Social media platforms</td>
                      <td className="p-4 border border-white/10 text-sm">Third-party social media services you choose to use with the Site.</td>
                      <td className="p-4 border border-white/10 text-sm">To support link sharing, social interactions, or any sign-in features you choose to use through those platforms.</td>
                    </tr>
                    <tr className="bg-white/5">
                      <td className="p-4 border border-white/10 font-bold text-white">Legal and professional parties</td>
                      <td className="p-4 border border-white/10 text-sm">Professional advisers, regulators, law enforcement, or legal authorities.</td>
                      <td className="p-4 border border-white/10 text-sm">To comply with legal obligations, respond to lawful requests, protect our rights, and manage legal or regulatory matters.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
