  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <Link 
          to="/" 
          className="inline-flex items-center gap-2 text-zinc-400 hover:text-brand transition-colors mb-8 group"
        >
        ...
        >
          ...
          <section className="space-y-4">
            <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">I am applying as:</label>
          ...
          <section className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              {role === "mc" ? (
                <>
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Name *</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Full Name *</label>
              ...
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Email Address *</label>
              ...
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Phone Number *</label>
              ...
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">City *</label>
            ...
            {role === "mc" ? (
              <>
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Battle Experience *</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Performance Style</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Audition Video Link *</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Short message / context about yourself</label>
              ...
              <>
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Instagram *</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Portfolio or modelling link</label>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Height</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Age (Optional)</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Availability</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Short introduction message</label>
                  <textarea name="Message" className="w-full bg-zinc-900 border border-white/5 rounded-2xl px-6 py-4 focus:outline-none focus:border-brand/50 transition-colors text-white" rows={4} value={formData.message} onChange={e => setFormData({...formData, message: e.target.value})} />
                </div>
              </>
            )}
            ...
            {role === "mc" && (
              <div className="grid md:grid-cols-3 gap-6">
                <div className="relative">
                  <Instagram className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-400" size={20} />
                ...
                <div className="relative">
                  <Music className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-400" size={20} />
                ...
                <div className="relative">
                  <Youtube className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-400" size={20} />
          ...
          <div className="pt-8">
            ...
            <p className="text-center mt-4 text-zinc-400 text-xs uppercase tracking-widest flex items-center justify-center gap-2">
