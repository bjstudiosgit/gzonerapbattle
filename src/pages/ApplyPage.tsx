    ...
    <div className="min-h-screen text-white pb-24 pt-40 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8" id="application-form">
        <div className="mb-16 md:mb-24 text-center lg:text-left">
          <h1 className="text-5xl md:text-8xl font-display italic uppercase mb-8 leading-[0.85] tracking-tighter shadow-2xl">
          ...
          <p className="text-zinc-500 text-sm md:text-lg uppercase font-black tracking-widest leading-relaxed opacity-80 max-w-2xl mx-auto lg:mx-0">
            The G-Zone is built for MCs who can <span className="text-white">write, perform, and hold their own</span> under pressure. 
            <span className="text-brand block mt-4 italic font-black">No gas. No hand-holding. No second chances.</span>
          </p>
        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div className="space-y-3">
              ...
              <input required name="Name" type="text" placeholder="MC Name" className="w-full bg-zinc-900/60 border border-white/5 rounded-2xl px-8 py-5 focus:outline-none focus:border-brand transition-all text-white font-display italic text-2xl uppercase tracking-wider" value={formData.mcName} onChange={e => setFormData({...formData, mcName: e.target.value})} />
            </div>
            <div className="space-y-3">
              <label className="text-[10px] uppercase font-black tracking-[0.4em] text-zinc-500 flex items-center gap-2">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              ...
              <textarea name="Message" placeholder="Why the G-Zone? What's your mission?" className="w-full bg-zinc-900/60 border border-white/5 rounded-3xl px-8 py-6 focus:outline-none focus:border-brand transition-all text-white font-bold text-sm md:text-base leading-relaxed h-40 resize-none" value={formData.message} onChange={e => setFormData({...formData, message: e.target.value})} />
            </div>
          ...
          <div className="pt-12">
            ...
            <div className="flex flex-col items-center gap-2 mt-8 opacity-50">
              ...
              <p className="text-center text-[8px] md:text-[9px] text-zinc-600 uppercase font-black tracking-widest max-w-sm leading-relaxed px-4">
                All submissions are vetted by the G-Zone panel. Low-effort recruitment is immediately terminated.
              </p>
            </div>
          </div>
        </form>
