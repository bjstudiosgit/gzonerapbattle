          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input name="Audition Link" type="url" placeholder="Paste your link here" className="w-full bg-zinc-900/60 border border-white/10 rounded-xl px-6 py-4 focus:outline-none focus:border-brand transition-all text-white text-base pr-16" value={formData.auditionLink} onChange={e => setFormData({...formData, auditionLink: e.target.value})} />
              </div>
            </div>
