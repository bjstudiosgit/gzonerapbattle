...
export default function ApplyPage() {
  const [role, setRole] = useState<"mc">("mc");
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pb-12 pt-32">
      ...
      <div className="max-w-3xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8" id="application-form">
        <div className="mb-12">
          <h1 className="text-3xl md:text-5xl font-display italic uppercase mb-4 leading-tight">
            THINK YOU’RE COLD? <span className="text-brand">PROVE IT.</span>
          </h1>
        ...
        >
          ...
          <div className="pt-8">
            ...
            <p className="text-center mt-4 text-zinc-400 text-xs uppercase tracking-widest flex items-center justify-center gap-2">
              <AlertCircle size={14} /> Warning: Applying may result in public humiliation, viral moments, and sudden respect
            </p>
          </div>
        </form>
      </div>
