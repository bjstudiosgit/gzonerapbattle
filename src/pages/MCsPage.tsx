      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between mb-16 md:mb-24 gap-12 text-center lg:text-left">
          <div className="flex-1">
            <h1 className="text-sm font-bold text-brand uppercase tracking-[0.5em] mb-4">Official Roster</h1>
            <h2 className="text-5xl md:text-9xl font-display italic uppercase leading-[0.8] mb-8">
            ...
            <p className="text-zinc-400 text-sm md:text-lg max-w-3xl leading-relaxed uppercase tracking-tight font-medium opacity-80 mx-auto lg:mx-0">
              The G-Zone roster brings together battle-tested MCs from across the scene. 
          ...
          <div className="flex flex-row lg:flex-col gap-4 w-full lg:w-auto shrink-0 justify-center">
            <div className="bg-zinc-900/60 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-3xl min-w-[160px] shadow-2xl group hover:border-brand/40 transition-all">
              <div className="text-brand font-display italic text-4xl md:text-6xl mb-1 group-hover:scale-110 transition-transform">{totalMCs}</div>
              <div className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Global Roster</div>
            </div>
            <div className="bg-zinc-900/60 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-3xl min-w-[160px] shadow-2xl group hover:border-brand/40 transition-all">
              <div className="text-white font-display italic text-4xl md:text-6xl mb-1 group-hover:scale-110 transition-transform">{activeMCsCount}</div>
        ...
        <div className="mb-24">
          <div className="flex items-center gap-4 mb-10">
            ...
            <h3 className="text-2xl md:text-4xl font-display italic uppercase flex items-center gap-4 text-white">
        ...
        {inactiveMcs.length > 0 && (
          <div className="relative">
            ...
            <div className="flex items-center gap-4 mb-10 opacity-50">
              ...
              <h3 className="text-2xl md:text-4xl font-display italic uppercase flex items-center gap-4 text-zinc-500">
                <AlertCircle size={24} /> In Lockdown
              </h3>
              <div className="h-px flex-1 bg-white/10" />
            </div>
