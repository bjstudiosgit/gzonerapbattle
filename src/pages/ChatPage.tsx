...
export default function ChatPage() {
  return (
    <div className="min-h-screen pt-24 pb-12 bg-zinc-950 flex flex-col">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-grow flex flex-col">
        <div className="text-center mb-8">
          ...
          >
            Dont make us go old school, you asked for it!
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="relative flex-grow w-full max-w-5xl mx-auto rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50 bg-black min-h-[500px] h-[60vh] md:h-[70vh] mb-8"
        >
          <Chat />
