      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-20 gap-8">
          <div className="text-center md:text-left">
            <h2 className="text-4xl md:text-7xl font-display uppercase leading-[0.8] mb-4">
              Season <span className="text-brand">01</span>
            </h2>
            <p className="text-brand font-bold tracking-[0.4em] text-[10px] md:text-base opacity-80">"Most Wanted" Division</p>
          </div>
