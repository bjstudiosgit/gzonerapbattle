        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between mb-16 md:mb-24 gap-12 text-center lg:text-left">
          <div className="flex-1 w-full">
            ...
            <p className="text-zinc-400 text-sm md:text-lg max-w-3xl leading-relaxed tracking-tight font-medium opacity-80 mx-auto lg:mx-0">
              The archive of high-stakes collisions. Every clash recorded here is a piece of Gzone history, where the UK’s 
              top-tier MCs settled scores and established dominance. Review the impact, track the views, and relive the 
              battles that defined the "Most Wanted" division.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full md:w-auto">
            ...
            <div className="bg-zinc-900/60 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[2rem] flex-1 md:min-w-[180px] shadow-2xl group hover:border-brand/30 transition-colors">
              ...
              <div className="text-4xl md:text-5xl font-display text-white group-hover:text-brand transition-colors">{battles.length}</div>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/5">
                {battles.map((battle, index) => {
                  ...
                  const statusText = "Tickets On Sale";
