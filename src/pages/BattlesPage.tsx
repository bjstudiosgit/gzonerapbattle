                  ...
                  return (
                    ...
                    >
                      <td className="px-2 py-3 md:px-6 md:py-6">
                        <Link to={`/battle/${battle.slug}`} className="font-mono text-brand text-[10px] md:text-sm hover:underline" aria-label={`Episode 1x${String(index + 1).padStart(2, '0')} details`}>1x{String(index + 1).padStart(2, '0')}</Link>
                      </td>
                      <td className="px-2 py-3 md:px-6 md:py-6">
