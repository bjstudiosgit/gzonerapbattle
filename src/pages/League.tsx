          ...
          {top3.map((mc, index) => {
             ...
             return (
              <motion.div
                ...
                className={`relative p-10 md:p-12 rounded-[3.5rem] border group transition-all duration-700 hover:-translate-y-2 overflow-hidden ${
                  tier.bg
              ...
              >
                <div className="absolute -top-8 left-1/2 z-30 flex -translate-x-1/2 items-center justify-center gap-1.5">
                  {[...Array(getStars(mc.rank, mc.points))].map((_, i) => (
                    <Star
                      key={i}
                      size={18}
