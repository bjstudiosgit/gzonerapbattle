  ...
  return (
    <div className="min-h-screen pt-40 pb-24 relative overflow-hidden bg-zinc-950">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute top-[20%] left-1/2 -translate-x-1/2 font-display italic text-[30vw] text-white/[0.02] uppercase leading-none select-none tracking-tighter">
          Champions
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 text-center lg:text-left">
            <div className="max-w-4xl">
              ...
              <motion.h1
                ...
                className="text-6xl md:text-[8rem] font-display italic uppercase leading-[0.75] tracking-tighter mb-12 shadow-2xl"
              >
              ...
              >
                <div className="flex-1">
                  <p className="text-zinc-500 text-sm md:text-lg uppercase font-black tracking-[0.2em] leading-relaxed max-w-2xl border-l-0 lg:border-l-2 border-brand/20 lg:pl-6 py-2">
                    The ultimate ranking for the G-Zone Arena. 
                    Victory is earned with every punch — <span className="text-white italic">3 points for a win, 1 for a match, 0 for a loss.</span> 
                  </p>
                </div>
              </motion.div>
            </div>
             ...
             return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-12">
                   <div className={`w-14 h-14 rounded-2xl flex items-center justify-center font-display italic text-3xl border-2 transition-all ${
                  ...
                  <div className="text-right">
                    ...
                    <p className={`text-4xl font-display italic tracking-tighter drop-shadow-md ${tier.text}`}>{mc.points}</p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="relative inline-block mb-10">
                    <div className={`w-28 h-28 md:w-36 md:h-36 rounded-[2.5rem] overflow-hidden border-2 transition-all duration-500 ${
                      ...
                      <div className="w-full h-full bg-zinc-800 flex items-center justify-center font-display italic text-6xl text-zinc-500">
                        {mc.name[0]}
                      </div>
                    </div>
                  ...
                  <Link to={`/mc/${mc.slug}`} className="block group/link">
                    <h3 className={`text-4xl md:text-5xl font-display italic uppercase leading-none mb-6 transition-colors ${tier.text} group-hover/link:opacity-80`}>
        ...
        >
          <div className="flex flex-col items-center mb-16">
            ...
            <h4 className="text-xl md:text-3xl font-display italic uppercase text-zinc-500 tracking-[0.2em]">The Full Standings</h4>
          </div>
