          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 text-center lg:text-left">
            <div className="w-full">
              ...
              >
                ...
                <span className="text-[10px] md:text-xs uppercase font-black tracking-[0.4em] text-brand">Season 01 "Most Wanted"</span>
              </motion.div>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-12">
                  ...
                  <div className="text-right">
                    <p className={`text-[10px] font-black tracking-widest opacity-60 mb-1 ${tier.text}`}>{tier.medal} Medalist</p>
