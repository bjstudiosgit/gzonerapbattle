          ...
          <div className="lg:col-span-2 space-y-8 lg:space-y-12">
              ...
              <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                ...
                <div className="mt-12 p-6 bg-zinc-950 border-2 border-brand/30 rounded-xl shadow-lg">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-white font-bold">Screenshots of Deeno&apos;s chat with Tapped gf</p>
                      <p className="text-zinc-400 text-sm">Used by Deeno to troll Tapped24</p>
                    </div>
                  </div>
                </div>
              </section>
            ...
            {battle.slug === 'ryno-vs-roman' && (
              <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                ...
                <div className="prose prose-invert prose-zinc max-w-none prose-lg">
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    Ryno vs Roman became a personal, hostile clash built around reputation, housing, family, and credibility. Roman brought the cleaner structure, repeatedly turning Ryno&apos;s image into a target while controlling the room with measured pressure and direct character attacks.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    Ryno answered with aggression and darker personal angles of his own, trying to match Roman&apos;s intensity and push the battle into more uncomfortable territory. The clash stayed tense throughout, but Roman&apos;s clearer angle work and stronger control carried the official result.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <article className="bg-zinc-950/70 border border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div className="space-y-6 text-zinc-300 leading-relaxed font-light">
                      ...
                      <p>Jigglypuff, Pen Zeppelin and Stairway to Heaven, and the pawn and checkmate sequence gave Ryno cleaner writing moments. His aggression, rebuttal energy, and stronger technical peaks gave him the edge.</p>
                    </div>
                  </article>
                  <article className="bg-zinc-950/70 border border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div className="space-y-6 text-zinc-300 leading-relaxed font-light">
                      ...
                      <p>2Mad also showed stronger crowd command than expected. The homelessness and political-image angles drove the battle story, but Ryno's cleaner high points and official result gave him the win.</p>
                    </div>
                  </article>
                </div>
              </section>
          ...
          <div className="space-y-8">
            ...
            {([
              ...
              ["2mwad-vs-ryno", [
                ...
                "2Mad built a strong story around Ryno's housing, money, hygiene, work, and public image, but the corrected battle record gives Ryno the win."
              ]],
              ["deluxx-vs-btizz", [
