                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                      {((battle.slug === 'deeno-vs-tymeless' ? [
                        ["Deeno", [
                          ...
                          ["TymeLess is in a Beta Squad — Young Philly.", "Deeno links TymeLess to Beta Squad and Young Filly, using the celebrity reference to frame his opponent as part of a comic group rather than a serious threat."],
                          ["Young Philly, see I've got the most bread in city.", "The Young Filly reference continues into a money and status boast, with Deeno claiming greater success and resources."],
