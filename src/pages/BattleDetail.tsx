...
export default function BattleDetail() {
  ...
  const schemaData = battle.videoUrl ? {
    ...
    "description": `${mc1?.name} faces ${mc2?.name} in this G-Zone rap battle.`,
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-zinc-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link 
          to={`/mc/${mc1?.slug}`} 
          aria-label={`Back to ${mc1?.name}'s MC Profile`}
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
                ...
                {battle.videoUrl ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-900 relative">
                    ...
                    <div className="relative z-10 text-center p-8">
                      ...
                      <p className="text-zinc-400 uppercase tracking-[0.2em] text-sm">The G Zone is processing the bars...</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            {battle.slug === 'renzo-vs-proty' && (
              <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                ...
                {/* GZone Disclaimer */}
                <h3 className="text-lg font-bold text-white mb-3 uppercase tracking-widest">GZone Disclaimer</h3>
                <p className="text-zinc-300 leading-relaxed font-light mb-8">
                  This battle was recorded before The GZone became aware of allegations concerning Renzo. We will not comment on ongoing legal matters, but we do not condone the behaviours alleged. Renzo is no longer affiliated with the platform. This battle is shared for entertainment purposes and to support Proty, whose performance deserves to be showcased.
                </p>
                ...
                <div className="prose prose-invert prose-zinc max-w-none prose-lg">
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    The battle between Renzo and Proty at The GZone Rap Battle League saw two of the platform’s younger competitors step into the ring for a fast-paced and highly competitive clash. From the beginning, the matchup carried a raw and energetic atmosphere, with both MCs bringing direct confrontation, sharp delivery, and a clear determination to make their mark.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    Across three rounds, both battlers leaned into aggressive personal angles and constant rebuttals, creating a tense back-and-forth throughout the contest. Renzo came with a forceful and confrontational style, using confidence, direct pressure, and bold references to try and overpower his opponent. Proty responded with a more measured but equally effective approach, mixing sharp counters, creative wordplay, and composed delivery to challenge Renzo at every stage.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    A major feature of the battle was the way both MCs continued to push through several technical interruptions, including microphone issues and restarts, without losing the intensity of the clash. Even with those disruptions, the energy in the room remained high, and both competitors managed to create standout moments that kept the crowd engaged. As the battle unfolded, the exchanges became more heated, with each round adding more pressure and more reaction from the audience.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    By the end of the battle, there was no immediate on-camera decision, with the result instead left open to audience debate and reaction. While the hosts discussed how close the contest had been, the final outcome was ultimately pushed to the viewers through a poll. That uncertainty only added to the impact of the clash, making Renzo versus Proty feel like one of the more competitive and closely contested battles in the GZone catalogue.
                  </p>
                </div>
              </section>
            )}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-brand/10 p-8 rounded-3xl border border-brand/20">
              ...
              <Link 
                to="/merch" 
                aria-label="Visit the official G Zone merch store"
