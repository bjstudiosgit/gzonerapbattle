  ...
  return (
    <div className="min-h-screen pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <ArrowLeft size={16} className="group-hover:-translate-x-1 transition-transform" /> Back to Files
        </Link>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
                ...
                {battle.videoUrl ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-900 relative">
                    ...
                    <div className="relative z-10 text-center p-8">
                      ...
                      <h3 className="text-3xl font-display uppercase text-white mb-2">Video Currently in Production</h3>
                      <p className="text-zinc-400 uppercase tracking-[0.2em] text-sm">The Gzone is processing the bars...</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-brand/10 p-8 rounded-3xl border border-brand/20">
              ...
              <Link 
                to="/merch" 
                aria-label="Visit the official Gzone merch store"
