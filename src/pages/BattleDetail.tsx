      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {/* Clash Summary for Ryno vs Roman */}
            {battle.slug === 'ryno-vs-roman' && (
              <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                ...
                <div className="prose prose-invert prose-zinc max-w-none prose-lg">
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    The clash between Ryno and Roman at The GZone Rap Battle League delivered one of the most hostile and personal battles from the Canning Town event. From the opening round, both MCs made it clear this was not a friendly lyrical exchange - it was a direct, aggressive confrontation built around reputation, character, and raw disrespect.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    Across three rounds, Roman pressured Ryno with sharp angles around credibility, behaviour, hygiene, and career momentum, using blunt accusations and mocking humour to sway the room. Ryno fired back with equally personal material, targeting Roman's family life, appearance, relationships, and past struggles, keeping the pressure high throughout.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    What made the battle stand out was how far both battlers were willing to go. The writing leaned heavily into personals and unverified claims about private life, giving the clash the feel of a genuine grudge match rather than a standard competitive exchange.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    By the end, the room had witnessed a battle filled with tension, crowd reaction, and some of the most ruthless material of the event. Roman is listed as the official winner, but the clash remains memorable for its intensity, personal edge, and no-filter approach to battle rap.
                  </p>
                </div>
              </section>
            )}
