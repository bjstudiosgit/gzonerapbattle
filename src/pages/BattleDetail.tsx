                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                      {((battle.slug === 'deeno-vs-tymeless' ? [
                        ["Deeno", [
                          ...
                          ["Young Philly, see I've got the most bread in city.", "The name reference becomes a money and status boast."],
                        ...
                        ["TymeLess", [
                          ...
                          ["Who brought Keith Lemon in?", "A recognisable UK comedy comparison starts the recurring lemon theme."],
                          ...
                          ["Ginger Jay giving himself a reload.", "TymeLess turns the host's reaction into part of the performance."],
