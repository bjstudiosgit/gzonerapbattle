            ...
            {battle.slug === '2mwad-vs-ryno' && (
              <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                ...
                <div className="prose prose-invert prose-zinc max-w-none prose-lg">
                  ...
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    After the document sequence, Ryno returns to prepared writing through fathers, pawn and checkmate, Katt Williams, performance criticism and a request for Deeno next. 2MWAD closes through snake, sheep, insect and fruit language, then returns to money, KFC, housing, professional status and alleged conduct. His &ldquo;GZone traveller, 3-0 massacre&rdquo; line turns the visitor role into a claim of a complete win.
                  </p>
                  <p className="text-zinc-300 leading-relaxed font-light mb-8">
                    The official GZone record awards Ryno the victory. Ryno produced the sharper isolated technical sequence and the battle&apos;s most consequential live defence, while 2MWAD sustained one opponent-specific portrait across all three rounds and repeatedly restored it after Ryno&apos;s rebuttals. The same housing, racism and NFA routes continue against Ryno in Episodes 11 and 18, showing that his official win did not close the angles used inside the clash.
                  </p>
                </div>
            ...
            {battle.slug === '2mwad-vs-ryno' && (
              <>
                ...
                <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ["2MWAD arrives from the Mikez loss", "LDN Mikez officially beat 2MWAD in Episode 4. Ryno's who-is-2Mad status question therefore attacks a battler still looking for his first recorded win; Episode 8 does not change that record because Ryno takes the official decision."],
                      ...
                      ["Ryno's official win does not kill 2MWAD's material", "Ryno wins here, with Pen Zeppelin, chess language and live rebuttal showing enough technical identity to carry into later clashes. Conversely, 2MWAD's housing case remains available to later opponents, proving that useful angles and official outcomes can travel separately."]
                    ].map(([title, detail]) => (
                      <article key={title} className="rounded-2xl border border-white/10 bg-zinc-950/70 p-6">
                        <h3 className="text-xl font-display uppercase text-brand mb-3">{title}</h3>
                        <p className="text-zinc-400 leading-relaxed font-light">{detail}</p>
                ...
                <section className="bg-zinc-900/30 p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      ["The loss continues into Episode 8", "Episode 4 gives 2MWAD his first official defeat. Ryno then gives him a second official defeat in Episode 8, so the Mikez result remains part of a 0-2 record."],
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <article className="bg-zinc-950/70 border border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div className="space-y-6 text-zinc-300 leading-relaxed font-light">
                      ...
                      <p>The debut shows a battler already capable of building a researched character case, but not yet sustaining that organisation across every turn. The official loss becomes useful context for Episode 8: against Ryno, housing, money and public-image routes expand into a more complete three-round narrative, but Ryno takes the official win.</p>
                    </div>
                  </article>
                  <article className="bg-zinc-950/70 border border-brand/30 rounded-2xl p-6 md:p-8">
                    <h3 className="text-2xl font-display uppercase text-brand mb-6">LDN Mikez</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <article className="bg-zinc-950/70 border border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div className="space-y-6 text-zinc-300 leading-relaxed font-light">
                      ...
                      <p>Audio restarts repeatedly damage rhythm, especially in the second, and the attack sometimes becomes a list of hostility rather than one sustained portrait. Ryno leaves with sharper isolated peaks and takes the official decision over 2MWAD.</p>
                    </div>
                  </article>
                  <article className="bg-zinc-950/70 border border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div className="space-y-6 text-zinc-300 leading-relaxed font-light">
                      ...
                      <p>The long rounds and repeated passages can sacrifice precision, but the best lines remain opponent-specific and the final GZone-traveller declaration summarises his position cleanly. The official record awards Ryno the win, leaving 2MWAD 0-2 after the Episode 4 loss to LDN Mikez.</p>
                    </div>
                  </article>
                </div>
              </section>
          ...
          <div className="space-y-8">
            ...
            {([
              ...
              ["ldn-mikez-vs-2mwad", [
                ...
                "The decision completes Mikez's prediction of consecutive wins after Deluxx. 2MWAD later develops a fuller three-round performance against Ryno in Episode 8 but takes a second official loss, while Mikez remains present in Episode 7 when BTizz alleges that he wrote Deluxx's material."
              ]],
              ["tapped24-vs-ajna", [
              ...
              ["2mwad-vs-ryno", [
                ...
                "The official GZone archive awards Ryno the win, his first recorded victory. That result did not close the story: homelessness, racism and NFA language all became inherited material in his later battles with TymeLess and Roman, while 2MWAD moved to 0-2."
              ]],
              ["deluxx-vs-btizz", [
