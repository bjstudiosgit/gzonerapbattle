...
export const battles: Battle[] = [
  {
    ...
    "isMainEvent": true,
    "props": [
      { name: "Screenshots of Deeno's chat with Tapped gf", user: "Deeno", icon: "📱" },
  ...
  },
  {
    ...
    "winner": "roman",
    "props": [
      { "name": "Ryno brought a sock for protection (dont ask)", "user": "Ryno", "icon": "🧦" }
    ],
    "isUnreleased": false,
    "isPlaceholder": false,
    "episode": "1x18"
...
export const lastUpdated = "5 Jul 2026";
