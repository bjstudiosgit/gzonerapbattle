...
export const mcs: MC[] = [
  ...
  },
  {
    ...
    image: "/mc1flaymr.png",
    bio: "A high-energy performer with aggressive flows and a sharp pen. In Season 1, 1Flaymr took an early loss to Btizz but bounced back with a win over CJ Zino, putting himself firmly in the Most Wanted mix.",
    isActive: true,
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://instagram.com",
  ...
  },
  {
    ...
    image: "/zk.png",
    bio: "Z.K made his Gzone debut against NattyEBK. With a direct punchline-focused style, he enters the Season 1 standings as a new name to watch.",
    isActive: true,
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://instagram.com",
  ...
  },
  {
    ...
    image: "/tricky.png",
    bio: "Trickyy is a new addition to the Gzone roster. More profile details coming soon.",
    isActive: true,
    location: "Rossendale"
  }
];
