...
export const mcs: MC[] = [
  ...
  },
  {
    ...
    image: "/zk.png",
    bio: "Z.K enters the Gzone as a fresh name on the Season 1 card. With NattyEBK waiting across the room, this debut profile is ready for the first official clash to set the tone.",
    isActive: true,
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://instagram.com",
