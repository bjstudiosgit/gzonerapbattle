...
export const mcs: MC[] = [
  ...
  },
  {
    ...
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://www.instagram.com/ajna3x/",
  ...
  },
  {
    ...
    image: "/mc1flaymr.png",
    bio: "A high-energy performer with aggressive flows and a sharp pen. In Season 1, 1Flaymr took an early loss to Btizz, then bounced back with wins over CJ Zino and Badee Harz.",
    isActive: true,
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://instagram.com",
  ...
  },
  {
    ...
    slug: "kime",
    name: "K.I.M.E",
    nickname: "King In My Element",
    battles: 0,
    wins: 0,
    losses: 0,
    style: "Grime / Rap / Technical",
    image: "/kime.png",
    bio: "K.I.M.E, meaning King In My Element, is a Moss Side, Manchester MC and battle rapper with more than 15 years behind the mic. Rooted in grime but equally comfortable across rap and hip-hop, K.I.M.E has built a reputation for sharp delivery, hard-hitting lyrics, clever wordplay and a distinctly Manchester sound.\n\nOver the years, he has developed a strong catalogue of music, collaborations and live performances, working alongside respected names from the Manchester and wider UK scene. His style combines experience, confidence and technical writing, with a pen built around punchlines, layered concepts and direct delivery.\n\nNow part of the GZone roster, K.I.M.E brings years of experience and authentic Moss Side energy into the arena, adding another serious Manchester name to the growing GZone lineup.",
    isActive: true,
