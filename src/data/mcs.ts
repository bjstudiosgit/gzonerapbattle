...
export const mcs: MC[] = [
  ...
  },
  {
    ...
    bio: "Tapped24 is currently locked up and taking some time out from the scene. His mix of disrespect, comedy, and strong performance energy still makes him one of the more crowd-focused battlers in the Gzone catalogue.",
    isActive: false,
  ...
  },
  {
    ...
    image: "/mc1flaymr.png",
    bio: "A high-energy performer with aggressive flows and a sharp pen. In Season 1, 1Flaymr took an early loss to Btizz but bounced back with a win over CJ Zino, earning a bonus point and putting himself firmly in the Most Wanted mix.",
    isActive: true,
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://instagram.com",
  ...
  },
  {
    ...
    image: "/zk.png",
    bio: "Z.K made his Gzone debut against NattyEBK and claimed the win, putting his first official points on the board. With a direct punchline-focused style, he enters the Season 1 standings as a new name to watch.",
    isActive: true,
    location: "London",
    coordinates: [51.5074, -0.1278],
    instagram: "https://instagram.com",
