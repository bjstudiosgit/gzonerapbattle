...
export default function FeaturedVideo() {
  return (
    <section className="relative w-full min-h-[40vh] overflow-hidden flex flex-col items-center justify-center py-6">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col items-center">
        ...
        >
          <h2 className="text-3xl md:text-6xl font-display italic uppercase mb-6 tracking-tighter leading-tight text-brand">
            Ginga Entertainment
          </h2>
        ...
        >
          <iframe
            ...
            src="https://www.youtube-nocookie.com/embed/Omge-TNTrhQ?mute=1&controls=0&modestbranding=1"
