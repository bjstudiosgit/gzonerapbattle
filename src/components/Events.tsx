...
const events = [
  ...
  },
  {
    ...
    image: defaultEventImage,
    description: "The first confirmed June battle is locked in. More announcements coming soon.",
    ticketsOnSale: true,
    card: [
      { episode: "1x22", mc1: "Badee Harz", mc2: "1Flaymr" },
      { episode: "1x23", mc1: "Natty EBK", mc2: "Deeno" },
      { episode: "1x24", mc1: "Grams", mc2: "Btizz" },
      { episode: "1x25", mc1: "CJ Zino", mc2: "Z.K" },
      { episode: "1x26", mc1: "Roman", mc2: "Trickyy" },
    ]
  },
];
