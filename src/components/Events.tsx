      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          >
            ...
            <div className="mt-6 inline-block bg-brand text-black px-6 py-2 rounded-full font-bold uppercase tracking-widest text-sm animate-pulse">
              Tickets Now On Sale
            </div>
          </motion.div>
        </div>
        ...
        {limit && (
          <div className="mt-12 flex justify-center">
            <Link to="/events" className="text-zinc-200 hover:text-white font-bold uppercase tracking-widest text-sm flex items-center gap-2 transition-colors">
