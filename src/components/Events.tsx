        ...
        <div className="text-left mb-20 md:mb-28">
          ...
          >
            ...
            <div className="max-w-3xl space-y-4">
               <p className="text-zinc-400 text-lg md:text-2xl uppercase tracking-tight font-medium">Step into the G-Zone where we dont play. This is the live arena for raw UK battle rap, where rising talent and established names clash in front of a crowd. From headline matchups to undercard wars, every battle carries weight, every round matters, and every MC is fighting to prove they belong.</p>
