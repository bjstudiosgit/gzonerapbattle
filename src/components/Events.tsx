        ...
        <div className="text-center mb-20 md:mb-28">
          ...
          >
            ...
            <div className="max-w-3xl mx-auto">
               <p className="text-zinc-500 text-sm md:text-xl uppercase font-black tracking-[0.3em] mb-4">No politics. No protection. Just Battle Rap.</p>
               <p className="text-zinc-600 text-[10px] md:text-sm uppercase font-bold tracking-[0.5em] opacity-60 leading-relaxed">
