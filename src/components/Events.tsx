        ...
        <div className="text-center mb-20 md:mb-24">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 bg-brand/10 border border-brand/20 rounded-full mb-8">
              ...
              <span className="text-[10px] uppercase font-black tracking-[0.4em] text-brand">Arena Schedule</span>
            </div>
            <h3 className="text-5xl md:text-8xl font-display italic uppercase leading-[0.8] tracking-tighter mb-8 shadow-2xl">
            ...
            <div className="flex flex-col items-center gap-2 mb-12">
               ...
               <p className="text-zinc-600 text-[10px] md:text-sm uppercase font-bold tracking-[0.5em] opacity-60">Just names getting tested in real time.</p>
            </div>
          ...
          {displayedEvents.map((event, index) => (
            ...
            >
              ...
              <div className="p-8 md:p-10">
                <h4 className="text-2xl md:text-3xl font-display italic uppercase mb-6 group-hover:text-brand transition-colors leading-none tracking-tight">
                  {event.title}
                </h4>
