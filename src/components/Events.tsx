...
const events = [
  ...
  },
  {
    ...
    description: "The June event has been postponed. New dates with the same battles plus more will be announced soon.",
    isPostponed: true,
    card: [
  ...
  },
  {
    ...
    date: "Manchester 11th & 12th July",
  ...
  return (
    ...
    >
      ...
      <div className="p-5 md:p-10">
        ...
        ) : !isCompleted && event.isPostponed ? (
          <div className="w-full bg-zinc-900/50 text-brand py-5 rounded-2xl font-black flex items-center justify-center gap-3 border border-brand/40 uppercase tracking-[0.3em] text-xs">
            POSTPONED
          </div>
