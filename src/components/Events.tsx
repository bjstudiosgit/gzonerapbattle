...
const mayMadnessFlyer = "/gzonebattlemay.png";
...
const events = [
  {
    ...
    price: "ARCHIVE",
    image: mayMadnessFlyer,
    description: "The winter card that set the tone for the season and locked in the G Zone energy.",
    isCompleted: true,
    card: [
      { mc1: "Deeno", mc2: "Roman", isMain: true },
      { mc1: "Tapped 24", mc2: "Ryno" },
      { mc1: "Badee Harz", mc2: "Btizz" }
    ]
  },
  {
    id: 2,
    ...
    isCompleted: true,
    card: [
      { mc1: "Grams", mc2: "Deeno", isMain: true },
      { mc1: "Ryno", mc2: "Roman" },
      { mc1: "Tapped 24", mc2: "1Flaymr" }
    ]
  },
  {
    id: 3,
    ...
    isCompleted: true,
    card: [
      { mc1: "Badee Harz", mc2: "Deeno", isMain: true },
      { mc1: "Roman", mc2: "Ryno" },
      { mc1: "Btizz", mc2: "Tapped 24" }
    ]
  },
  {
    id: 4,
  ...
  },
  {
    ...
    location: "G ZONE HQ",
    price: "CARD ANNOUNCED",
    image: mayMadnessFlyer,
    card: [
      { episode: "1x19", mc1: "Deeno", mc2: "Tapped 24" },
      { episode: "1x20", mc1: "Roman", mc2: "Tymeless" },
      { episode: "1x21", mc1: "C.J Zino", mc2: "1 Flaymah" },
      { episode: "1x22", mc1: "Natty EBK", mc2: "Z.K" },
      { episode: "1x23", mc1: "A.J", mc2: "Badee Harz" },
      { episode: "1x24", mc1: "Btizz", mc2: "Grams" }
    ]
  },
];
      ...
      <div className="relative h-64 overflow-hidden">
        <img
          ...
          onError={(e) => {
            ...
            if (target.src.endsWith(mayMadnessFlyer)) return;
            target.src = mayMadnessFlyer;
          }}
        />
          ...
          <div className="mb-8 space-y-2 bg-black/40 p-4 rounded-2xl border border-white/5">
            ...
            {event.card.map((match, i) => (
              <div key={i} className={`flex items-center gap-2 text-[10px] md:text-xs font-bold uppercase tracking-wider ${match.isMain ? 'text-white' : 'text-zinc-400'}`}>
                {match.episode && <span className="font-mono text-brand/70 shrink-0">{match.episode}</span>}
    ...
    <section id="events" className="relative py-24 md:py-32 overflow-hidden bg-[#050505] scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-left mb-20 md:mb-28">
          ...
          >
            <h2 className="text-sm font-black text-brand uppercase tracking-[0.4em] mb-5">Season 1</h2>
            <h3 className="font-display text-5xl md:text-8xl uppercase leading-[0.8] tracking-tighter drop-shadow-[0_10px_22px_rgba(0,0,0,0.75)]">
              <span className="text-white">Most</span> <span className="text-brand">Wanted</span>
            </h3>
            <div className="mt-5 mb-10 flex items-center gap-3 text-yellow-500">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
        ...
        <div className="mb-24">
          <div className="flex items-end justify-between gap-8 mb-10">
            <div>
              ...
              <p className="mt-3 text-zinc-500 text-xs md:text-sm font-bold uppercase tracking-[0.25em]">Cards still building pressure</p>
            </div>
          </div>
