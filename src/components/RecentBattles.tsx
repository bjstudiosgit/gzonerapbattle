            ...
            return (
              ...
              >
                ...
                <div className="absolute top-4 left-4 z-20 flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest shadow-2xl border border-white/10 bg-[#f27d26] text-white shadow-orange-600/40">
