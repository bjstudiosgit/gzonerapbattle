...
export default function RecentBattles() {
  ...
  return (
    <section id="battles" className="relative py-12 md:py-24 overflow-hidden scroll-mt-24">
      {/* Background Flow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <h3 className="text-3xl md:text-6xl font-display italic uppercase leading-tight mb-2">New battles <br className="md:hidden" /><span className="text-brand">landing soon</span></h3>
          <p className="text-brand font-bold uppercase tracking-[0.2em] text-[10px] md:text-sm">Season 1 "Most Wanted"</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-3 left-3 z-20 flex gap-2">
                  {battle.isUnreleased ? (
                    <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-orange-500 text-white text-[7px] md:text-[8px] font-black uppercase tracking-[0.2em] shadow-lg shadow-orange-500/20">
                      <Clock size={8} /> Production
                    </div>
                  ) : (
                    <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-brand text-black text-[7px] md:text-[8px] font-black uppercase tracking-[0.2em] shadow-lg shadow-brand/20">
                ...
                <div className="absolute inset-0 z-10 p-4 md:p-6 flex flex-col justify-end">
                  <div className="mb-2">
                    <span className="text-brand font-black text-[7px] md:text-[8px] tracking-[0.3em] uppercase mb-1 block">
                      Episode 1x{String(battles.findIndex(b => b.id === battle.id) + 1).padStart(2, '0')}
                    </span>
                    <h4 className="text-lg md:text-xl font-display italic uppercase leading-none group-hover:text-brand transition-colors relative z-40">
