    ...
    <section id="battles" className="relative py-16 md:py-24 overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 md:mb-20">
          <h3 className="text-4xl md:text-6xl font-display italic uppercase leading-none mb-6">
              ...
              >
                    ...
                    <div className="w-full h-full relative flex overflow-hidden bg-zinc-900">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
                        <div className="bg-black/90 backdrop-blur-md border border-brand/40 w-14 h-14 rounded-full flex items-center justify-center transform -rotate-12 group-hover:rotate-0 transition-all duration-500 shadow-[0_0_20px_rgba(242,125,38,0.3)]">
                          <span className="text-brand font-display italic text-2xl">VS</span>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="absolute inset-0 z-10 p-6 flex flex-col justify-end">
                  <div className="mb-2">
                    ...
                    <h4 className="text-2xl md:text-3xl font-display italic uppercase leading-none group-hover:text-brand transition-colors drop-shadow-2xl">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 bg-zinc-900/50 px-6 py-3 rounded-full border border-white/5">
              <div className="w-2 h-2 rounded-full bg-brand animate-pulse shadow-[0_0_10px_rgba(242,125,38,0.8)]" />
              <span className="text-[12px] font-bold uppercase tracking-[0.2em] text-zinc-300">
                Live Status: <span className="text-white">{unreleasedCount} Battles</span> in post-production
              </span>
            </div>
          </div>
          ...
          <Link 
            to="/battles" 
            className="text-brand hover:text-white transition-colors text-xs font-black uppercase tracking-[0.3em] flex items-center gap-2 group"
          >
            View All Battles <Play size={10} className="group-hover:translate-x-1 transition-transform" fill="currentColor" />
          </Link>
        </div>
      </div>
    </section>
