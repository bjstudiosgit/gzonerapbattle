        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="relative aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-brand/20 z-10">
              <img 
                src={portraitImage(judge.image, "profile")} 
                alt={judge.name} 
                width={600}
                height={800}
                ...
                onError={(e) => {
                  ...
                  if (!target.src.endsWith(judge.image)) {
                    target.src = judge.image;
                    return;
                  }
          ...
          >
            <div className="mb-8">
              ...
              {judge.quote && (
                <div className="mb-8 border-l-4 border-brand pl-6 py-2">
                  ...
                  <p className="text-xl font-display text-zinc-300 leading-tight">
                    "{judge.quote}"
                  </p>
                </div>
              )}
            ...
            <div className="p-8 bg-zinc-900/30 rounded-3xl border border-white/5 relative overflow-hidden group">
              ...
              <div className="text-zinc-400 leading-relaxed relative z-10 whitespace-pre-line">
                {judge.leagueRoleDescription || `As a ${judge.role}, ${judge.name} provides expert analysis and scoring for the battles in the Gzone.`}
              </div>
            </div>
          </motion.div>
        </div>
