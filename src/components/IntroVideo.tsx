            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 w-full">
              <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-0 items-center relative">
                ...
                >
                  ...
                  <div className="mb-10">
                    <h1 className="text-2xl md:text-5xl font-display leading-[1.1] uppercase mb-6 tracking-tight">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-6 md:gap-8 mt-8">
                      <span className="text-brand font-black uppercase tracking-[0.4em] text-[12px] md:text-sm">
                        Season 1 "Most Wanted"
                      </span>
