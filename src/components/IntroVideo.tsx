            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                ...
                >
                  ...
                  <div className="mb-10">
                    <h1 className="text-xl md:text-5xl font-display italic leading-[1.1] uppercase mb-4 tracking-tight">
                      "It's the <span className="text-brand">G League baby</span> where we don't play"
                    </h1>
                  </div>
                  
                  <p className="text-zinc-200 text-base max-w-xl mb-10 leading-relaxed">
