              ...
              <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                ...
                >
                  <a 
                    ...
                    aria-label="Watch Featured Battle: The G Zone Experience"
                  >
                    <img 
                    ...
                    <div className="absolute bottom-6 left-6 right-6 p-6 bg-zinc-900/90 backdrop-blur-xl rounded-2xl border border-white/10 group-hover:border-brand/50 transition-all duration-500 shadow-2xl">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-zinc-400 text-[10px] font-bold uppercase tracking-widest flex items-center gap-1 group-hover:text-white transition-colors">
