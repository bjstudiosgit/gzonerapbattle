        ...
        {!videoEnded ? (
          ...
          >
            ...
            <button 
              ...
              className="text-white/50 hover:text-brand transition-colors uppercase tracking-[0.3em] text-[10px] font-bold flex items-center gap-2 group"
            >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                ...
                >
                  ...
                  <div className="text-zinc-500 text-xs md:text-sm font-bold uppercase tracking-[0.3em] mb-8">
                  ...
                  <div className="mt-12 flex items-center gap-8">
                    ...
                    <div>
                      ...
                      <div className="text-zinc-500 text-[10px] uppercase tracking-widest">Pro MCs</div>
                    </div>
                    <div className="w-px h-8 bg-zinc-800" />
                    <div>
                      <div className="text-3xl font-display italic">1</div>
                      <div className="text-zinc-500 text-[10px] uppercase tracking-widest">Seasons</div>
                    </div>
                  </div>
                </motion.div>
                  ...
                  >
                    ...
                    <div className="absolute bottom-8 left-8 right-8 p-6 bg-zinc-900/90 backdrop-blur-md rounded-2xl border border-white/5 group-hover:border-brand/50 transition-colors">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-brand font-bold text-xs uppercase tracking-widest">Out Now</span>
                        <span className="text-zinc-500 text-[10px] flex items-center gap-1 uppercase tracking-widest">
                          <Play size={10} fill="currentColor" /> Watch Now
                        </span>
                      </div>
                      <h3 className="text-xl font-display italic uppercase text-orange-500 group-hover:text-brand transition-colors">Season 1</h3>
                    </div>
                  </a>
