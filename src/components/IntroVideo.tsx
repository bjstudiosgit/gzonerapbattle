...
import { Play, ChevronRight, Share2, Star } from "lucide-react";
        ...
        >
          <video
            ...
            onTimeUpdate={(e) => {
              ...
              if (video.duration - video.currentTime <= 2 && !videoEnded) {
                setVideoEnded(true);
              }
            }}
        ...
        {!videoEnded ? (
          ...
          >
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 w-full">
              <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-0 items-center relative">
                <motion.div
                  initial={{ opacity: 0, x: -50 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: 0.1, duration: 0.6 }}
                  className="max-w-4xl relative z-10 pr-8"
                >
                  <div className="hidden md:inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand/10 border border-brand/20 text-brand text-xs font-bold uppercase tracking-widest mb-6">
                  ...
                  <div className="mb-12 md:mb-16">
                    <h1 className="text-2xl md:text-5xl font-display leading-[1.1] uppercase mb-4 md:mb-6 tracking-tight">
                      This is the Gzone Baby, <br className="md:hidden"/> <span className="text-brand text-4xl md:text-7xl lg:text-[5rem] xl:text-[5.5rem] block mt-2 whitespace-nowrap">Where we dont Play!</span>
                    </h1>
                    <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-4 md:gap-8 mt-4 md:mt-6">
                      <span className="font-display uppercase tracking-tight text-2xl md:text-5xl leading-none">
                        <span className="text-white">Season 1</span> <span className="text-brand">"Most Wanted"</span>
                      </span>
                      <div className="flex items-center gap-2">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="text-yellow-500 fill-yellow-500 animate-pulse" size={18} />
                        ))}
                      </div>
                    </div>
                  </div>
                  
                  <p className="text-zinc-200 text-sm md:text-base font-medium tracking-normal max-w-2xl mb-6 md:mb-10 leading-relaxed opacity-80">
                    This is Gzone, where reputations get built or buried. If you step in, you’re stepping into pressure, noise, and a room that doesn’t care who you are, only what you do. Bars land or they don’t. The crowd backs you or they don’t. Simple. No hand-holding, no second chances, just moments that either make you or break you. <br/>
                  </p>
                  ...
                  <div className="mt-8 pt-4 md:mt-16 md:pt-8 border-t border-white/10 flex flex-wrap items-center justify-center md:justify-start gap-4 md:gap-12">
                    <div className="group text-center md:text-left">
                      <div className="text-xl md:text-4xl font-display text-white group-hover:text-brand transition-colors">12.1K</div>
                ...
                >
                  <div className="relative group w-full max-w-[550px] xl:max-w-[800px] ml-auto">
                    {/* Ambient Glow */}
                    ...
                    <img 
                      ...
                      alt="Ginga Jay" 
                      className="relative z-10 w-full max-h-[85vh] object-contain object-right transition-all duration-700 group-hover:scale-105 group-hover:-translate-y-4 drop-shadow-[0_30px_60px_rgba(0,0,0,0.8)]"
