              ...
              <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-zinc-200 text-lg max-w-xl mb-10 leading-relaxed">
                    Welcome to the G Zone.<br />
                    A new stage for battle rap — built for the next generation of MCs.<br /><br />
                    Unfiltered clashes. Real competition. No gatekeeping.<br /><br />
                    Earn your place or get left behind.
                  </p>
