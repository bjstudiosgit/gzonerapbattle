                ...
                >
                  ...
                  <div className="mb-10">
                    <h1 className="text-2xl md:text-5xl font-display leading-[1.1] uppercase mb-6 tracking-tight">
                      This is the Gzone Baby "Most Wanted" <br className="md:hidden"/> <span className="text-brand text-4xl md:text-7xl lg:text-[5rem] xl:text-[5.5rem] block mt-2 whitespace-nowrap">Where we dont Play!</span>
                    </h1>
                    <div className="mt-4 flex items-center justify-center gap-3 text-yellow-500 md:justify-start">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                  ...
                  <p className="text-zinc-200 text-sm md:text-base font-medium tracking-normal max-w-2xl mt-4 mb-6 md:mt-8 md:mb-10 leading-relaxed opacity-80">
