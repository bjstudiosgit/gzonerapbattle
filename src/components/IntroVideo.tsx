              ...
              <div className="grid lg:grid-cols-[1.28fr_0.72fr] gap-8 items-center relative">
                ...
                >
                  ...
                  <div className="mb-6 max-w-3xl">
                    ...
                    <p className="mt-6 max-w-3xl text-justify text-sm sm:text-xl leading-relaxed text-zinc-300">
                      All performances occur within a controlled environment and are for entertainment purposes only. The G-Zone provides a platform where MCs can express themselves freely in a setting built on respect, discipline, and behavioural standards. Licensed security is present at all events. The G-Zone does not endorse prejudice, racism, discrimination, or violence of any kind.
                    </p>
                  </div>
                  ...
                  <div className="mb-12 grid w-full max-w-3xl grid-cols-5">
                    <div className="px-2 py-2 text-center sm:py-3">
                      <div className="font-display text-xl sm:text-3xl text-brand">13.2K</div>
                  ...
                  <div>
                    <div className="flex w-full max-w-3xl flex-col items-start justify-center gap-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <Link
                        to="/events"
                        className="inline-flex items-center gap-3 px-2 py-3 font-display text-xl uppercase text-brand transition-colors hover:text-white"
                      >
