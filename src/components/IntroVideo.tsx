            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-zinc-200 text-sm md:text-base tracking-widest max-w-xl mb-6 md:mb-10 leading-relaxed">
                  ...
                  <div className="mt-8 pt-4 md:mt-16 md:pt-8 border-t border-white/10 flex flex-wrap items-center justify-center md:justify-start gap-4 md:gap-12">
                    <div className="group text-center md:text-left">
                      <div className="text-xl md:text-4xl font-display italic text-white group-hover:text-brand transition-colors">11.4K</div>
