              ...
              <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-0 items-center relative">
                ...
                >
                  ...
                  <p className="text-zinc-200 text-sm md:text-base font-medium tracking-normal max-w-2xl mb-6 md:mb-10 leading-relaxed opacity-80">
                    This is G-Zone — where reputations get built or buried. If you step in, you’re stepping into pressure, noise, and a room that doesn’t care who you are — only what you do. Bars land or they don’t. The crowd backs you or they don’t. Simple. No hand-holding, no second chances — just moments that either make you or break you. <br/>
                  </p>
