          ...
          >
            <div className="max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-6 w-full">
              <div className="grid lg:grid-cols-[1.28fr_0.72fr] gap-8 items-center relative">
                ...
                >
                  <div className="mb-2">
                    <h1 className="whitespace-nowrap font-display uppercase text-[clamp(1.8rem,5.5vw,5.5rem)] leading-none tracking-tight text-white drop-shadow-[0_12px_35px_rgba(0,0,0,0.9)]">
