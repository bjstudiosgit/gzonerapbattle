      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-5xl md:text-8xl font-display uppercase leading-[0.8] mb-6"
          >
              ...
              {selectedLocation && (
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <h3 className="text-3xl font-display uppercase text-white tracking-tight leading-none mb-1">{selectedLocation}</h3>
                    ...
                    {selectedMCs.map(mc => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-lg font-display text-white uppercase tracking-tight group-hover:text-brand transition-colors">{mc.name}</div>
