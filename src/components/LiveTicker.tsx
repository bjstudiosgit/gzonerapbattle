...
export default function LiveTicker() {
  const items = [
    { text: "LATEST: TAPPED 24 DEFEATED GRAMS", type: "live" },
    ...
    { text: "BTIZZ VS 1FLAYMR OUT NOW ON YOUTUBE", type: "live" },
    { text: "MAY TICKETS ON SALE NOW", type: "ticket" },
    { text: "NOTE: DATE CHANGE FROM SATURDAY 30TH MAY TO SUNDAY 31ST MAY DUE TO THE FOOTBALL", type: "upcoming" },
