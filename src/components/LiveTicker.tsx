...
export default function LiveTicker() {
  const items = [
    ...
    { text: "POSTPONED: 27TH JUNE GZONE LIVE EVENT", type: "ticket" },
    { text: "DUE TO UNFORESEEN CIRCUMSTANCES - NEW DATE ANNOUNCED SOON", type: "upcoming" },
    { text: "STAY SAFE IN THIS HEAT - THE GZONE", type: "upcoming" },
