      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {showTitle && (
          <div className="text-center mb-16 md:mb-24">
            ...
            <h3 className="text-4xl md:text-7xl font-display italic uppercase leading-[0.8] mb-8 tracking-tighter">
                    ...
                    >
                      <td className="px-6 py-8 md:px-10 md:py-10">
                        <div className="flex items-center gap-2">
                           <span className={`font-display italic text-2xl md:text-4xl leading-none transition-colors ${
                      ...
                      <td className="px-6 py-8 md:px-10 md:py-10">
                        <Link to={`/mc/${mc.slug}`} className="flex items-center gap-4 group/name relative">
                          <div className={`relative w-10 h-10 md:w-14 md:h-14 shrink-0 rounded-2xl overflow-hidden border-2 transition-all duration-500 ${isTop3 ? 'border-brand/40 shadow-[0_0_20px_rgba(242,125,38,0.2)]' : 'border-white/5 group-hover/name:border-brand/30'}`}>
                            <div className="w-full h-full bg-zinc-800 flex items-center justify-center font-display italic text-xl md:text-2xl text-zinc-500">
                              {mc.name[0]}
                            </div>
                          ...
                          <div className="flex flex-col">
                            <span className={`font-display italic text-lg md:text-2xl uppercase tracking-tight transition-colors flex items-center gap-2 ${mc.isDsq ? 'text-zinc-500 line-through' : 'text-zinc-100 group-hover/name:text-brand'}`}>
                              {mc.name}
                      ...
                      <td className={`px-6 py-8 md:px-10 md:py-10 text-center font-display italic text-2xl md:text-3xl bg-white/[0.02] ${isTop3 ? 'text-brand drop-shadow-[0_0_10px_rgba(242,125,38,0.3)]' : 'text-zinc-500'}`}>
