                        ...
                        <Link to={`/mc/${mc.slug}`} className="flex items-center gap-4 group/name relative">
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              {mc.isDsq ? (
                                <span className="text-[7px] md:text-[9px] font-black uppercase tracking-[0.2em] px-2 py-0.5 bg-zinc-900 border border-zinc-700/50 rounded-md text-zinc-300">COOLING OFF</span>
                              ) : (
