...
import { Clock, Trophy, BadgeAlert, Info, ArrowUpRight } from "lucide-react";
            ...
            <table className="w-full text-left border-collapse min-w-[700px] md:min-w-0">
              <thead>
                <tr className="bg-zinc-950/80 border-b border-white/10">
                  ...
                  <th className="px-6 py-6 md:px-10 md:py-10 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-200 text-center bg-white/5">Points</th>
                </tr>
              </thead>
                          ...
                          <div className="flex flex-col">
                            <span className={`font-display text-lg md:text-2xl uppercase tracking-tight transition-colors flex items-center gap-2 ${mc.isDsq ? 'text-zinc-500 line-through' : 'text-zinc-100 group-hover/name:text-brand'}`}>
                              ...
                              {!mc.isDsq && mc.rank === 1 && (
                                <BadgeAlert
                                  size={14}
                                  className="inline text-red-500 drop-shadow-[0_0_8px_rgba(239,68,68,0.35)] animate-pulse"
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              {mc.isDsq ? (
                                ...
                                <span className="text-[7px] md:text-[9px] font-black uppercase tracking-[0.2em] text-zinc-500">Season 1</span>
                              )}
                            </div>
                          </div>
                        </Link>
