...
import { ArrowLeft, Mic2, Trophy, Zap, Play, MapPin, Ruler, Weight, Instagram, Youtube, Quote, Crown } from "lucide-react";
  ...
  return (
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to="/mcs" className="inline-flex items-center gap-2 text-zinc-300 hover:text-brand transition-colors mb-12 uppercase tracking-widest text-xs font-bold">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div className="mb-8">
              <h1 className="text-7xl font-display italic uppercase leading-tight mb-2 flex items-center gap-4">
                {mc.name}
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                {mc.tags && mc.tags.length > 0 && (
                  <div className="flex gap-2">
                    {mc.tags.map(tag => (
                      <span key={tag} className="bg-brand text-black text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest shadow-lg">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              {mc.quote && (
                <div className="mb-8 border-l-4 border-brand pl-6 py-2">
                  ...
                  <p className="text-xl font-display italic uppercase text-zinc-200 leading-tight">
                    "{mc.quote}"
                  </p>
                </div>
              )}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <Link 
                            ...
                            className="text-xl font-display italic uppercase group-hover:text-brand transition-colors hover:underline decoration-brand/30 underline-offset-4"
                          >
                            {opponent?.name}
                          </Link>
                        </div>
