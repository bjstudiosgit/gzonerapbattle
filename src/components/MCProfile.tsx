                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          {battle.winner === mc.id && battle.bonusPoints && battle.bonusPoints > 0 && (
                            <div className="mt-1 text-[10px] font-black uppercase tracking-[0.2em] text-brand">
                              +{battle.bonusPoints} Bonus Points
                            </div>
                          )}
                        </div>
                      </div>
