      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className={`relative aspect-[4/5] md:aspect-[3/4] max-h-[430px] md:max-h-none mx-auto rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-brand/20 z-10 ${isLockedUp ? 'grayscale' : ''}`}>
              <img 
