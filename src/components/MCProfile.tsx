      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="absolute -bottom-4 right-0 md:-bottom-6 md:-right-6 w-20 h-20 md:w-32 md:h-32 bg-brand rounded-full flex items-center justify-center font-display text-3xl md:text-5xl text-black -rotate-12 z-20 shadow-xl">
              {mc.name[0]}
            </div>
          </motion.div>
