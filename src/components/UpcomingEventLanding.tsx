...
import { Calendar, MapPin, Ticket, Clock, ChevronRight, ChevronLeft, X, ThermometerSun } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="max-w-xs text-xs md:text-sm font-display text-brand uppercase leading-snug tracking-[0.22em] md:tracking-[0.4em] mb-4 md:mb-6">June event update</h2>
              ...
              <div className="mb-10 flex max-w-3xl gap-4 border border-white/10 border-l-brand bg-gradient-to-r from-brand/10 via-white/[0.045] to-white/[0.02] px-5 py-5 shadow-[0_16px_50px_rgba(0,0,0,0.25)]">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-brand text-black shadow-[0_0_24px_rgba(242,125,38,0.25)]">
                  <ThermometerSun size={24} />
                </div>
                <div className="min-w-0">
                  <p className="text-zinc-400 text-base md:text-lg leading-6 md:leading-relaxed font-medium">
                    Due to unforeseen circumstances, the GZone Live event on the 27th June has been postponed.
                    We apologise for any inconvenience. New dates with the same battles plus more will be announced very soon.
                  </p>
                  <div className="mt-5 flex items-center gap-3 border-t border-white/10 pt-4">
                    <span className="font-display text-2xl uppercase leading-none text-white">35C</span>
                    <span className="text-[10px] font-black uppercase tracking-[0.24em] text-brand">Weather advisory</span>
                  </div>
                </div>
              </div>
          ...
          >
              ...
              <div className="relative aspect-[4/5] md:aspect-video lg:aspect-[4/5] bg-zinc-900 rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent p-8 flex flex-col justify-end">
                  ...
                  <h3 className="text-4xl md:text-6xl font-display uppercase leading-none mb-4 tracking-tighter">
                    Event <span className="text-brand">Postponed</span>
                  </h3>
                  <div className="flex flex-wrap gap-6 text-sm font-bold uppercase tracking-widest text-zinc-300">
                    ...
                    <div className="flex items-center gap-2 rounded-full border border-brand/30 bg-black/35 px-3 py-1 text-brand">
                      <ThermometerSun size={16} className="text-brand" />
                      35C advisory
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <Link
              to="/events"
              className="mt-6 inline-flex w-full items-center justify-center gap-3 rounded-xl border border-brand/40 bg-brand/10 px-6 py-4 font-display text-xl uppercase text-brand transition-colors hover:bg-brand hover:text-black"
            >
              Event Postponed <Clock size={20} />
            </Link>
          </motion.div>
        </div>
      </div>
