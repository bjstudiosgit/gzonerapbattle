        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-sm font-black text-brand uppercase tracking-[0.4em] mb-6">May Madness Complete</h2>
              ...
              <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-medium">
                May Madness took place on 31st May at Peacock Gymnasium. Tymeless and Deeno
                headlined a stacked night of clashes. Tap the flyer to view the full card and match-ups.
              </p>
