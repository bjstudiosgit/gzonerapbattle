          ...
          >
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-24 bg-brand flex flex-col items-center justify-center shadow-[0_0_50px_rgba(242,125,38,0.5)] border-4 border-white z-30 pointer-events-none"
              >
                <span className="text-3xl font-black text-black uppercase tracking-tighter leading-none">BATTLES</span>
                <span className="text-2xl font-black text-black uppercase tracking-tighter leading-none">COMING SOON</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
