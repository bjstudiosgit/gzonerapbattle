        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-sm font-black text-brand uppercase tracking-[0.4em] mb-6">Main Event Out Now</h2>
              <h3 className="text-4xl md:text-6xl font-display uppercase leading-tight mb-8 tracking-tight">
                Tapped24 VS Grams <br />
                <span className="text-zinc-700">Watch The Clash</span>
              </h3>
              
              <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-medium">
                The April main event is live from the G-Zone arena. Tapped24 and Grams headline
                the latest drop from a stacked card of veterans, rising stars, and certified
                pressure moments.
              </p>
              ...
              <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl md:col-span-2 border-brand/30 bg-brand/5">
                  ...
                  <div className="text-xl md:text-2xl font-display uppercase">Tapped24 <span className="text-brand/40 italic text-sm">VS</span> Grams</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest mb-2">Co-Main</div>
                  <div className="text-lg font-display uppercase">Ricko G <span className="text-brand/40 italic text-sm">VS</span> Deeno</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
          ...
          >
            ...
            >
              ...
              <div className="relative aspect-[4/5] md:aspect-video lg:aspect-[4/5] bg-zinc-900 rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                <img 
                  src={flyerImage("/flyers/26thAprilall.png", "card")} 
              ...
              <motion.div 
                ...
                animate={{ scale: 1.1, opacity: 1, rotate: -12 }}
                transition={{ 
                  type: "spring",
                  stiffness: 260,
                  damping: 20,
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[22rem] max-w-[calc(100vw-2rem)] h-24 bg-brand flex flex-col items-center justify-center shadow-[0_0_50px_rgba(242,125,38,0.5)] border-4 border-white z-30 pointer-events-none"
              >
                <span className="text-2xl md:text-3xl font-black text-black uppercase tracking-tighter leading-none">TAPPED24 VS GRAMS</span>
                <span className="text-2xl font-black text-black uppercase tracking-tighter leading-none">OUT NOW</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
