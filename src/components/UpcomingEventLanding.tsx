        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-sm font-black text-brand uppercase tracking-[0.4em] mb-6">Next Event</h2>
              <h3 className="text-4xl md:text-6xl font-display uppercase leading-tight mb-8 tracking-tight">
                27th June 2026 <br />
                <span className="text-zinc-700">Peacocks Boxing, Canning Town</span>
              </h3>
              
              <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-medium">
                Four new clashes land at Peacocks Boxing in Canning Town. Tap the flyer to explore
                the match-ups and share the official artwork.
              </p>
              ...
              <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-brand font-black uppercase tracking-widest mb-2">Collision</div>
