            ...
            >
              ...
              <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest mb-2">Date</div>
                  <div className="text-lg font-display uppercase">Dates to be confirmed</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-brand font-black uppercase tracking-widest mb-2">Location</div>
                  <div className="text-lg font-display uppercase">To be confirmed</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
