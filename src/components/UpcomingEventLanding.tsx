        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-sm font-black text-brand uppercase tracking-[0.4em] mb-6">Live Show - 30th May</h2>
              <h3 className="text-4xl md:text-6xl font-display uppercase leading-tight mb-8 tracking-tight">
                Tymeless VS Deeno <br />
                <span className="text-zinc-700">May Madness</span>
              </h3>
              
              <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-medium">
                The G-Zone returns to Peacock Gymnasium on Saturday 30th May with Tymeless and
                Deeno at the top of a stacked live card. Doors open at 4:00PM, first battle starts
                at 5:00PM, and tickets start from £10.
              </p>
              ...
              <div className="hidden md:grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest mb-2">Main Event</div>
                  <div className="text-lg font-display uppercase">Roman <span className="text-brand/40 italic text-sm">VS</span> Marni Grams</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest mb-2">Full Card</div>
                  <div className="text-lg font-display uppercase">C.J Zino <span className="text-brand/40 italic text-sm">VS</span> 1Flaymah</div>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  <div className="text-[10px] text-zinc-500 font-black uppercase tracking-widest mb-2">Full Card</div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl">
                  ...
                  <div className="text-lg font-display uppercase">AJ <span className="text-brand/40 italic text-sm">VS</span> Badee Harz</div>
                </div>
              </div>
            </motion.div>
          </div>
