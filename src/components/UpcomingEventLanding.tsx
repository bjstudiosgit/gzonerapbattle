        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            ...
            >
              ...
              <p className="text-zinc-400 text-lg mb-10 leading-relaxed font-medium">
                The May Madness card is locked for 30th May at Peacock Gymnasium. Tymeless and Deeno
          ...
          >
            ...
            >
              ...
              >
                <span className="text-2xl md:text-3xl font-black text-black uppercase tracking-tighter leading-none">TYMELESS VS DEENO</span>
                <span className="text-2xl font-black text-black uppercase tracking-tighter leading-none">ON SALE NOW</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
