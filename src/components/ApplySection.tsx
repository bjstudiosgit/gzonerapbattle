    ...
    <section className="py-24 bg-zinc-950 relative overflow-hidden border-b border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-zinc-200 text-lg md:text-xl mb-16 leading-relaxed max-w-3xl mx-auto">
          ...
          {[
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-zinc-200 leading-relaxed whitespace-pre-line text-center text-sm md:text-base">{point.desc}</p>
              </div>
