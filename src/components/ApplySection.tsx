      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-zinc-300 text-lg md:text-xl mb-12 max-w-3xl mx-auto leading-relaxed">
            The G-Zone is built for MCs who can write, perform, and hold their own under pressure. This isn’t an open mic—it’s a platform for those who have something real to say. No gas, no hand-holding, no second chances. If you’ve got something real, step forward.
          </p>
        </motion.div>
