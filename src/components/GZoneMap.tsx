  ...
  return (
    <section className="py-24 bg-black overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-zinc-950 border border-white/5 rounded-[2rem] overflow-hidden aspect-[4/5] md:aspect-video flex items-center justify-center group/map shadow-2xl">
