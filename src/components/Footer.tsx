...
export default function Footer() {
  return (
    <footer className="bg-zinc-900 border-t border-white/5 py-8 md:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2 text-left flex flex-col items-start">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.tiktok.com/@the.gzone.rbl" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-400 hover:bg-brand hover:text-black transition-all" aria-label="Follow us on TikTok">
          ...
          <div className="grid grid-cols-2 gap-6 md:col-span-2 md:grid-cols-2">
            <div className="text-left">
              ...
              <ul className="space-y-1 text-xs text-zinc-400">
                <li><Link to="/battles" className="hover:text-brand transition-colors">Battles</Link></li>
                <li><Link to="/events" className="hover:text-brand transition-colors">Tickets</Link></li>
                <li><Link to="/mcs" className="hover:text-brand transition-colors">MCs</Link></li>
                <li><Link to="/map" className="hover:text-brand transition-colors">Gzone</Link></li>
              </ul>
            </div>
            
            <div className="text-left">
              <h5 className="font-bold uppercase tracking-widest text-[10px] mb-2 text-zinc-500">Community</h5>
              <ul className="space-y-1 text-xs text-zinc-400">
                <li><Link to="/chat" className="hover:text-brand transition-colors">Chat</Link></li>
                <li><Link to="/staff" className="hover:text-brand transition-colors">Staff</Link></li>
                <li><Link to="/league" className="hover:text-brand transition-colors">League</Link></li>
                <li><Link to="/apply" className="hover:text-brand transition-colors">Apply</Link></li>
                <li><Link to="/lost-property" className="hover:text-brand transition-colors">Lost Property</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-8 text-zinc-500 text-[10px] uppercase tracking-widest">
            <span>Designed by <a href="https://www.bjstudio.co.uk" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-brand transition-colors">BJStudio</a>, Manchester</span>
          </div>
        </div>
      </div>
    </footer>
