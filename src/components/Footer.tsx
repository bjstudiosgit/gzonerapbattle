      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 mb-16">
          <div className="lg:col-span-2 text-left">
            <Link to="/" className="inline-flex items-center gap-4 mb-8 group/logo">
              <div className="w-10 h-10 bg-brand rounded-xl flex items-center justify-center font-display text-2xl text-black italic shadow-[0_0_20px_rgba(242,125,38,0.3)] transition-transform group-hover/logo:scale-110">G</div>
              <div className="flex flex-col leading-none">
                <span className="font-display text-2xl tracking-tighter uppercase italic leading-none text-white group-hover/logo:text-brand transition-colors">THE G <span className="text-brand group-hover/logo:text-white">ZONE</span></span>
                <span className="text-[7px] text-zinc-500 uppercase font-black tracking-[0.3em] mt-1.5 opacity-60">In Association with Peacock Gymnasium</span>
              </div>
            </Link>
            ...
            <p className="text-zinc-500 text-sm md:text-base uppercase font-black tracking-widest leading-relaxed max-w-md mb-10 opacity-80">
              The UK’s <span className="text-white">uncensored arena</span> for the next generation of MCs. <br className="hidden md:block" />
              Where battle rap meets <span className="text-brand">real entertainment.</span>
            </p>
          ...
          <div className="grid grid-cols-2 gap-12 lg:col-span-2">
            <div>
              ...
              <ul className="space-y-4">
                <li><Link to="/battles" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">Battles Archive</Link></li>
                ...
                <li><Link to="/map" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">Arena Map</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link to="/chat" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">The Zone Chat</Link></li>
                <li><Link to="/staff" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">Staff Access</Link></li>
                <li><Link to="/league" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">Standings</Link></li>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-zinc-600 text-[10px] uppercase font-black tracking-[0.3em] order-2 md:order-1">
            © 2026 THE G ZONE. OPERATED BY GINJA ENTERTAINMENT.
          </p>
