    ...
    <footer className="bg-zinc-950 border-t border-white/5 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-10">
            ...
            <div className="flex items-center gap-2 mb-4">
              <Link to="/" className="flex items-center gap-2">
                ...
                <div className="flex flex-col leading-none">
                  <span className="font-display text-xl tracking-tighter uppercase italic">The G Zone</span>
                </div>
              </Link>
            </div>
            <p className="text-zinc-400 text-sm max-w-sm mb-6">
              The UK’s uncensored arena showcasing the best up-and-coming MCs. Where entertainment meets battle rap.
            </p>
          ...
          <div>
            <h5 className="font-bold uppercase tracking-widest text-[10px] mb-4 text-zinc-500">Support</h5>
            <ul className="space-y-2 text-xs text-zinc-400">
