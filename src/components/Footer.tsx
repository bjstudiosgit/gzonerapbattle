        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 mb-16">
          <div className="lg:col-span-2 text-left">
            <Link to="/" className="inline-flex items-center gap-2 mb-8 group/logo">
              <div className="w-12 h-12 flex items-center justify-center transition-transform group-hover/logo:scale-110 overflow-hidden">
            ...
            <p className="text-zinc-500 text-sm md:text-base font-black tracking-widest leading-relaxed max-w-md mb-10 opacity-80">
          ...
          <div className="grid grid-cols-2 gap-12 lg:col-span-2">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/battles/mc" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">The Roster</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/chat" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">GINGAHOO V2.0</Link></li>
                <li><Link to="/staff" className="text-zinc-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-[0.2em]">Meet the Crew</Link></li>
