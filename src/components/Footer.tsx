        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-300 hover:bg-brand hover:text-black transition-all" aria-label="Follow us on Instagram">
                <Instagram size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-300 hover:bg-brand hover:text-black transition-all" aria-label="Follow us on Twitter">
                <Twitter size={20} />
              </a>
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-300 hover:bg-brand hover:text-black transition-all" aria-label="Follow us on Facebook">
                <Facebook size={20} />
              </a>
            </div>
          </div>
