      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <motion.h2
            ...
            className="text-3xl md:text-6xl font-display uppercase mb-6 tracking-tighter"
          >
            Gzone <span className="text-brand">Fan Chat</span>
          </motion.h2>
        ...
        <div className="mt-8 text-center">
          <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-zinc-600">
            Powered by Supabase Realtime • Gzone Official Chat
          </p>
        </div>
      </div>
    </section>
