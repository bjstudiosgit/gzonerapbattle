  ...
  return (
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to="/" className="inline-flex items-center gap-2 text-zinc-400 hover:text-brand transition-colors mb-12 uppercase tracking-widest text-xs font-bold">
          ...
          >
            ...
            <div className="p-8 bg-zinc-900/30 rounded-3xl border border-white/5 relative overflow-hidden group">
              ...
              <div className="text-zinc-400 leading-relaxed relative z-10 whitespace-pre-line">
                {host.leagueRoleDescription || `As a ${host.role}, ${host.name} is responsible for maintaining the high-octane atmosphere of the G Zone. Whether it's introducing the combatants or providing expert commentary, they are an essential part of the Ginga Entertainment family.`}
              </div>
            </div>
          </motion.div>
        </div>
