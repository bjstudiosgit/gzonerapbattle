...
export default function Merch() {
  return (
    <section id="merch" className="py-12 md:py-24 scroll-mt-24 relative overflow-hidden">
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="text-center mb-12">
          <h2 className="text-sm font-bold text-brand uppercase tracking-[0.3em] mb-4">Official Gear</h2>
          <h3 className="text-3xl md:text-6xl font-display uppercase leading-tight">
            You missed it. <br />
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-brand font-display">{product.price}</span>
