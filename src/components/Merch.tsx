      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-12 bg-zinc-900 rounded-3xl border border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-md">
            ...
            <p className="text-zinc-500">Get early access to limited drops and exclusive event merch.</p>
          </div>
          <div className="flex w-full md:w-auto gap-2">
            ...
            />
            <button className="bg-brand text-black px-6 py-3 rounded-xl font-bold">Join</button>
          </div>
        </div>
      </div>
    </section>
