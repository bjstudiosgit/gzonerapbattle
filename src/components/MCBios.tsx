...
export default function MCBios() {
  ...
  return (
    <section id="mcs" className="py-12 md:py-24 relative bg-black scroll-mt-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <h3 className="text-3xl md:text-6xl font-display italic uppercase mb-6">The <span className="text-brand">GZone</span> Roster</h3>
        </div>
