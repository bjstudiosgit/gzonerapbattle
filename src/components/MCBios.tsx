      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-16 gap-8">
          <div className="max-w-xl">
            ...
            <p className="text-zinc-300 mt-4">Discover the battle rappers and MCs making waves in the UK battle rap scene.</p>
          </div>
            ...
            >
              <Link to={`/mc/${mc.slug}`} className="block p-4" aria-label={`View ${mc.name} profile`}>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between text-[10px] text-zinc-300 font-bold uppercase tracking-wider">
