      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center mb-20">
          <div className="max-w-4xl">
            <div className="md:hidden inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand/10 border border-brand/20 text-brand text-[10px] font-bold uppercase tracking-widest mb-8">
              <Trophy size={12} />
            ...
            <p className="text-zinc-400 text-lg md:text-xl max-w-3xl mx-auto mb-12 leading-relaxed opacity-80">
              Earn it. 3 points for a win. 1 point for a loss. Nothing else matters.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {top3.map((mc, index) => (
            (() => {
              const tier = getTierColors(mc.rank);
              return (
            <motion.div
              key={mc.id}
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="relative mb-6">
                  ...
                  <div className={`mb-4 flex justify-center ${tier.trophy}`}>
                    <Trophy size={32} strokeWidth={1.5} />
                  </div>
                  
                  <div className={`w-32 h-32 rounded-full overflow-hidden border-2 p-1 ${tier.border}`}>
