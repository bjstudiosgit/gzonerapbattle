        ...
        <div className="flex items-center justify-between h-24">
          <div className="flex items-center shrink-0">
            <Link to="/" onClick={() => setIsOpen(false)} className="flex items-center gap-4 group/logo">
              <div className="w-12 h-12 bg-brand rounded-none flex items-center justify-center font-black text-2xl text-black shadow-[0_0_20px_rgba(242,125,38,0.3)] group-hover:scale-110 transition-transform">G</div>
