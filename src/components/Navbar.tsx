        ...
        <div className="flex items-center justify-between h-24">
          <div className="flex items-center shrink-0">
            <Link to="/" onClick={() => setIsOpen(false)} className="flex items-center gap-4 group/logo">
              <div className="w-12 h-12 bg-brand rounded-none flex items-center justify-center font-display text-3xl text-black shadow-[0_0_20px_rgba(242,125,38,0.3)] group-hover:scale-110 transition-transform">G</div>
              <div className="flex flex-col leading-none">
                <span className="font-display text-3xl tracking-tighter uppercase leading-none text-white group-hover:text-brand transition-colors">THE <span className="text-brand group-hover:text-white">GZONE</span></span>
                <span className="text-[8px] text-zinc-500 uppercase font-black tracking-[0.2em] mt-1.5 opacity-60">In Association with <br /> Peacock Gymnasium</span>
              </div>
            </Link>
          </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="md:hidden relative z-10 bg-zinc-950 border-b border-white/10 overflow-y-auto max-h-[calc(100vh-6rem)]"
          >
