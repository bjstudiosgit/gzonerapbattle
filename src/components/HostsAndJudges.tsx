    ...
    const content = (
      <>
        ...
        <div className="absolute bottom-8 left-8 right-8">
          <h4 className="text-2xl md:text-3xl font-display italic uppercase leading-none group-hover:text-brand transition-all duration-300 transform group-hover:-translate-y-1">{person.name}</h4>
        </div>
      </>
    );
