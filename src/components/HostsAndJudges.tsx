    ...
    <section id="staff" className="py-12 md:py-24 bg-black relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <h3 className="text-3xl md:text-6xl font-display italic uppercase leading-tight">Let me hear you say <span className="text-brand">what?</span></h3>
          <p className="text-zinc-200 mt-4 text-sm md:text-base">Meet the team running the UK's most uncensored arena.</p>
        </div>
