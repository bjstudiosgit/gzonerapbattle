  ...
  const card = (
    ...
    >
      <img
        ...
        loading="lazy"
        decoding="async"
        className={`h-full w-full object-cover object-top grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0 ${person.isMystery ? "blur-xl opacity-40" : ""}`}
