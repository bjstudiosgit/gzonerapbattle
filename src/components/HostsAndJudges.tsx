...
export default function HostsAndJudges() {
  ...
  const louisBowers = [staffHosts[2]];
  ...
  return (
    <section id="staff" className="py-24 bg-zinc-950 relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16">
          <h4 className="text-xl font-display italic uppercase text-brand border-l-4 border-brand pl-4 mb-6">Production</h4>
          <motion.div 
            layout
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"
          >
            {louisBowers.map(renderPerson)}
          </motion.div>
        </div>
      </div>
    </section>
