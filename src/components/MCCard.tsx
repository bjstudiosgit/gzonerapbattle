  ...
  return (
    ...
    >
      <Link to={`/mc/${mc.slug}`} onClick={handleClick} className="block w-full h-full" aria-label={`View ${mc.name} profile`}>
        ...
        {/* Corner Icon - Moved to top-right to avoid badge */}
        <div className="absolute top-3 right-3 z-20 opacity-50 group-hover:opacity-100 transition-opacity">
        ...
        {/* WANTED Badge for Top 3 Rank MCs */}
        {rank >= 1 && rank <= 3 && !isLockedUp && (
